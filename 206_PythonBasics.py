...
# Section Day/Time: 002 Wednesday 6-7pm
# People you worked with: Madi Sabo
...
def task0():
    print('Frankie Antenucci')
    print('My expected score is a 60')
...
def name_counts(names):
    ...
    lst.sort(key = lambda x : x[0]) #sorting names alphabetically
    lst.sort(key = lambda x : x[1], reverse = True) #sorting counts from largest to smallest
